...
export class User extends BaseEntity {
    ...
    @Column("varchar", { name: "email", nullable: true, length: 100, default: "''" })
    email: string | null;

    @Column("varchar", { name: "name", nullable: true, length: 100, default: "''" })
    name: string | null;
    ...
    @Column("varchar", { name: "avatar", nullable: true, length: 255, default: "''" })
    avatar: string | null;
    ...
    @Column("int", { name: "latitude", nullable: true, default: "'0'" })
    latitude: number | null;

    @Column("int", { name: "longitude", nullable: true, default: "'0'" })
    ...
    @Column("tinyint", { name: "is_personal", default: () => "'1'" })
    isPersonal: number;

    @Column("tinyint", { name: "verify_kyc", default: () => "'0'" })
    verifyKyc: number;

    @Column("varchar", { name: "verify_option_1", length: 255, nullable: true, default: "''" })
    verifyOption_1: string | null;

    @Column("varchar", { name: "verify_option_2", length: 255, nullable: true, default: "''" })
    verifyOption_2: string | null;
